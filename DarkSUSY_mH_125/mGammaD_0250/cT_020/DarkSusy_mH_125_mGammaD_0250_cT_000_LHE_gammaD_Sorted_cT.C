...
//=========  (Mon Mar 16 16:00:51 2015) by ROOT version5.34/18
   ...
   cnv->Range(-2.125,-0.2887111,10.375,1.932144);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(1.776684);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.9870467);
   h_gammaD_2_cT->SetBinContent(2,0.01295337);
