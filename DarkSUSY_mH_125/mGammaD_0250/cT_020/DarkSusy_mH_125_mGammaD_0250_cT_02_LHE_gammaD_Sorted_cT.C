...
//=========  (Mon Mar 16 16:16:53 2015) by ROOT version5.34/18
   ...
   cnv->Range(-0.2125,-0.9481299,1.0375,6.345177);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(5.834646);
   ...
   h_gammaD_1_cT->SetBinContent(1,3.354922);
   h_gammaD_1_cT->SetBinContent(2,1.062176);
   h_gammaD_1_cT->SetBinContent(3,0.4015544);
   h_gammaD_1_cT->SetBinContent(4,0.1295337);
   h_gammaD_1_cT->SetBinContent(5,0.05181347);
   h_gammaD_1_cT->SetEntries(386);
   ...
   h_gammaD_2_cT->SetBinContent(1,3.24147);
   h_gammaD_2_cT->SetBinContent(2,1.181102);
   h_gammaD_2_cT->SetBinContent(3,0.3674541);
   h_gammaD_2_cT->SetBinContent(4,0.1574803);
   h_gammaD_2_cT->SetBinContent(5,0.05249344);
   h_gammaD_2_cT->SetBinContent(6,0.0656168);
   h_gammaD_2_cT->SetEntries(386);
