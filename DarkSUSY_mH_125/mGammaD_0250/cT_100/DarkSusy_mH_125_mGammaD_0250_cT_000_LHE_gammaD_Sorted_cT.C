...
//=========  (Mon Mar 16 16:01:03 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-2.125,-0.180867,10.375,1.210417);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(1.113027);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.6073394);
   h_gammaD_1_cT->SetBinContent(2,0.2568807);
   h_gammaD_1_cT->SetBinContent(3,0.08256881);
   h_gammaD_1_cT->SetBinContent(4,0.03302752);
   h_gammaD_1_cT->SetBinContent(5,0.0146789);
   h_gammaD_1_cT->SetBinContent(6,0.001834862);
   h_gammaD_1_cT->SetBinContent(9,0.003669725);
   h_gammaD_1_cT->SetEntries(545);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.6183486);
   h_gammaD_2_cT->SetBinContent(2,0.2513762);
   h_gammaD_2_cT->SetBinContent(3,0.0880734);
   h_gammaD_2_cT->SetBinContent(4,0.02568807);
   h_gammaD_2_cT->SetBinContent(5,0.00733945);
   h_gammaD_2_cT->SetBinContent(6,0.005504587);
   h_gammaD_2_cT->SetBinContent(7,0.003669725);
   h_gammaD_2_cT->SetEntries(545);
