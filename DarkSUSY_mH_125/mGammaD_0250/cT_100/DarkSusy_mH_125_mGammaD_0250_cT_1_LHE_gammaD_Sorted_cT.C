...
//=========  (Mon Mar 16 16:16:58 2015) by ROOT version5.34/18
   ...
   cnv->Range(-1.0625,-0.1825417,5.1875,1.221625);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(1.123333);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.6107011);
   h_gammaD_1_cT->SetBinContent(2,0.2583026);
   h_gammaD_1_cT->SetBinContent(3,0.08302583);
   h_gammaD_1_cT->SetBinContent(4,0.03321033);
   h_gammaD_1_cT->SetBinContent(5,0.01476015);
   h_gammaD_1_cT->SetBinContent(6,0.005535055);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.6240741);
   h_gammaD_2_cT->SetBinContent(2,0.2537037);
   h_gammaD_2_cT->SetBinContent(3,0.08888889);
   h_gammaD_2_cT->SetBinContent(4,0.02592593);
   h_gammaD_2_cT->SetBinContent(5,0.007407407);
   h_gammaD_2_cT->SetBinContent(6,0.009259259);
