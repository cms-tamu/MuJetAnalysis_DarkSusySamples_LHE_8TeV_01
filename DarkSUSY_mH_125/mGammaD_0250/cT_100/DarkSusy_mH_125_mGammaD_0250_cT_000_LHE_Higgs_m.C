...
//=========  (Mon Mar 16 15:59:58 2015) by ROOT version5.34/18
   ...
   h_higgs_M__5->SetBinError(5,0.04283529);
   h_higgs_M__5->SetEntries(545);
   ...
   h_higgs_M__6->SetBinError(5,0.04283529);
   h_higgs_M__6->SetEntries(545);
   ...
   h_higgs_M__7->SetBinError(5,0.04283529);
   h_higgs_M__7->SetEntries(545);
