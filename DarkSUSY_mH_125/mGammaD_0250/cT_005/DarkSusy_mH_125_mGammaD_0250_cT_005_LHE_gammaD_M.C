...
//=========  (Mon Mar 16 16:17:21 2015) by ROOT version5.34/18
   ...
   h_gammaD_1_M__41->SetBinContent(2,0.9996675);
   h_gammaD_1_M__41->SetBinContent(10,0.0003324468);
   h_gammaD_1_M__41->SetBinError(2,0.01823009);
   h_gammaD_1_M__41->SetBinError(10,0.0003324468);
   h_gammaD_1_M__41->SetEntries(3008);
