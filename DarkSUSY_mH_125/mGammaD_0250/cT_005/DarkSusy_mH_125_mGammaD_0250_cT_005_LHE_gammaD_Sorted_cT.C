...
//=========  (Mon Mar 16 16:16:53 2015) by ROOT version5.34/18
   ...
   cnv->Range(-0.053125,-3.795442,0.259375,25.40027);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(23.35657);
   ...
   h_gammaD_1_cT->SetBinContent(1,12.6738);
   h_gammaD_1_cT->SetBinContent(2,4.532085);
   h_gammaD_1_cT->SetBinContent(3,1.885027);
   h_gammaD_1_cT->SetBinContent(4,0.6684492);
   h_gammaD_1_cT->SetBinContent(5,0.2406417);
   h_gammaD_1_cT->SetBinContent(6,0.1069519);
   ...
   h_gammaD_2_cT->SetBinContent(1,12.97587);
   h_gammaD_2_cT->SetBinContent(2,4.504022);
   h_gammaD_2_cT->SetBinContent(3,1.662198);
   h_gammaD_2_cT->SetBinContent(4,0.616622);
   h_gammaD_2_cT->SetBinContent(5,0.2412869);
   h_gammaD_2_cT->SetBinContent(6,0.1608579);
