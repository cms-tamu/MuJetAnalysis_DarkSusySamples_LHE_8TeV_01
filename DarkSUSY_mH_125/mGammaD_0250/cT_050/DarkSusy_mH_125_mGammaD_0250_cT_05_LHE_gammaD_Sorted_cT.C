...
//=========  (Mon Mar 16 16:17:08 2015) by ROOT version5.34/18
   ...
   cnv->Range(-0.53125,-0.3686894,2.59375,2.467383);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(2.268858);
   ...
   h_gammaD_1_cT->SetBinContent(1,1.220115);
   h_gammaD_1_cT->SetBinContent(2,0.489695);
   h_gammaD_1_cT->SetBinContent(3,0.1929101);
   h_gammaD_1_cT->SetBinContent(4,0.06595218);
   h_gammaD_1_cT->SetBinContent(5,0.03132729);
   h_gammaD_1_cT->SetBinContent(6,0.01813685);
   ...
   h_gammaD_2_cT->SetBinContent(1,1.260477);
   h_gammaD_2_cT->SetBinContent(2,0.5078061);
   h_gammaD_2_cT->SetBinContent(3,0.157765);
   h_gammaD_2_cT->SetBinContent(4,0.05751849);
   h_gammaD_2_cT->SetBinContent(5,0.01643385);
   h_gammaD_2_cT->SetBinContent(6,0.0115037);
