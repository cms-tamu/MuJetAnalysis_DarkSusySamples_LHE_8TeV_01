...
//=========  (Mon Mar 16 16:01:04 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-2.125,-0.2571323,10.375,1.720809);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(1.582353);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.8472222);
   h_gammaD_1_cT->SetBinContent(2,0.128268);
   h_gammaD_1_cT->SetBinContent(3,0.02369281);
   h_gammaD_1_cT->SetBinContent(4,0.0008169935);
   h_gammaD_1_cT->SetEntries(1224);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.8790849);
   h_gammaD_2_cT->SetBinContent(2,0.1070261);
   h_gammaD_2_cT->SetBinContent(3,0.0122549);
   h_gammaD_2_cT->SetBinContent(4,0.001633987);
   h_gammaD_2_cT->SetEntries(1224);
