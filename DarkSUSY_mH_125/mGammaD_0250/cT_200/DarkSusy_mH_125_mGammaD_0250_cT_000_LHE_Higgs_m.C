...
//=========  (Mon Mar 16 16:00:02 2015) by ROOT version5.34/18
   ...
   h_higgs_M__5->SetBinError(5,0.02688988);
   h_higgs_M__5->SetEntries(1383);
   ...
   h_higgs_M__6->SetBinError(5,0.02688988);
   h_higgs_M__6->SetEntries(1383);
   ...
   h_higgs_M__7->SetBinError(5,0.02688988);
   h_higgs_M__7->SetEntries(1383);
