...
//=========  (Mon Mar 16 16:17:13 2015) by ROOT version5.34/18
   ...
   cnv->Range(-2.125,-0.09369806,10.375,0.6270563);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.5766035);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.3137755);
   h_gammaD_1_cT->SetBinContent(2,0.1264577);
   h_gammaD_1_cT->SetBinContent(3,0.04300291);
   h_gammaD_1_cT->SetBinContent(4,0.01129738);
   h_gammaD_1_cT->SetBinContent(5,0.005466472);
   h_gammaD_1_cT->SetBinContent(6,0.004008746);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.3203353);
   h_gammaD_2_cT->SetBinContent(2,0.1155248);
   h_gammaD_2_cT->SetBinContent(3,0.04409621);
   h_gammaD_2_cT->SetBinContent(4,0.01457726);
   h_gammaD_2_cT->SetBinContent(5,0.005466472);
   h_gammaD_2_cT->SetBinContent(6,0.004008746);
