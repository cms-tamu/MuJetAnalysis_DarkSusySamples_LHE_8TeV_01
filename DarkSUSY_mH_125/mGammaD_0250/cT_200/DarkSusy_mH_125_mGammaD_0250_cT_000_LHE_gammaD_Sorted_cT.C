...
//=========  (Mon Mar 16 16:01:09 2015) by ROOT version5.34/18
   ...
   cnv->Range(-2.125,-0.118535,10.375,0.7932726);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.7294461);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.3804665);
   h_gammaD_1_cT->SetBinContent(2,0.2470845);
   h_gammaD_1_cT->SetBinContent(3,0.1618076);
   h_gammaD_1_cT->SetBinContent(4,0.09110788);
   h_gammaD_1_cT->SetBinContent(5,0.05685131);
   h_gammaD_1_cT->SetBinContent(6,0.02915452);
   h_gammaD_1_cT->SetBinContent(7,0.01020408);
   h_gammaD_1_cT->SetBinContent(8,0.01239067);
   h_gammaD_1_cT->SetBinContent(9,0.004373178);
   h_gammaD_1_cT->SetBinContent(10,0.006559767);
   h_gammaD_1_cT->SetBinContent(11,0.008017492);
   h_gammaD_1_cT->SetEntries(1383);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.4052478);
   h_gammaD_2_cT->SetBinContent(2,0.2354227);
   h_gammaD_2_cT->SetBinContent(3,0.1450437);
   h_gammaD_2_cT->SetBinContent(4,0.08600583);
   h_gammaD_2_cT->SetBinContent(5,0.05466472);
   h_gammaD_2_cT->SetBinContent(6,0.0335277);
   h_gammaD_2_cT->SetBinContent(7,0.02040816);
   h_gammaD_2_cT->SetBinContent(8,0.008746356);
   h_gammaD_2_cT->SetBinContent(9,0.006559767);
   h_gammaD_2_cT->SetBinContent(10,0.004373178);
   h_gammaD_2_cT->SetBinContent(11,0.008017492);
   h_gammaD_2_cT->SetEntries(1383);
