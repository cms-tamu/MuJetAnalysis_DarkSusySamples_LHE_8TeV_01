...
//=========  (Mon Mar 16 16:17:12 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-3.1875,-0.06025751,15.5625,0.4032618);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.3708155);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.2212685);
   h_gammaD_1_cT->SetBinContent(2,0.07725322);
   h_gammaD_1_cT->SetBinContent(3,0.02479733);
   h_gammaD_1_cT->SetBinContent(4,0.006199332);
   h_gammaD_1_cT->SetBinContent(5,0.003814974);
   h_gammaD_1_cT->SetBinContent(6,0.002384359);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.2060086);
   h_gammaD_2_cT->SetBinContent(2,0.08059132);
   h_gammaD_2_cT->SetBinContent(3,0.03290415);
   h_gammaD_2_cT->SetBinContent(4,0.009060563);
   h_gammaD_2_cT->SetBinContent(5,0.004768717);
   h_gammaD_2_cT->SetBinContent(6,0.002384359);
