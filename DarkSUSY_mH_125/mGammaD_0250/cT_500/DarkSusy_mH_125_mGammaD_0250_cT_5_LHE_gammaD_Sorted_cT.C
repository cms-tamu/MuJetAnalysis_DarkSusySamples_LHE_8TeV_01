...
//=========  (Mon Mar 16 17:14:00 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-5.3125,-0.03701454,25.9375,0.2477127);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.2277818);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.1279766);
   h_gammaD_1_cT->SetBinContent(2,0.04850256);
   h_gammaD_1_cT->SetBinContent(3,0.0165084);
   h_gammaD_1_cT->SetBinContent(4,0.003944485);
   h_gammaD_1_cT->SetBinContent(5,0.003067933);
   h_gammaD_1_cT->SetBinContent(6,0.001899197);
   h_gammaD_1_cT->SetEntries(1382);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.1265455);
   h_gammaD_2_cT->SetBinContent(2,0.04785455);
   h_gammaD_2_cT->SetBinContent(3,0.01745455);
   h_gammaD_2_cT->SetBinContent(4,0.006254545);
   h_gammaD_2_cT->SetBinContent(5,0.001890909);
   h_gammaD_2_cT->SetBinContent(6,0.001018182);
   h_gammaD_2_cT->SetEntries(1382);
