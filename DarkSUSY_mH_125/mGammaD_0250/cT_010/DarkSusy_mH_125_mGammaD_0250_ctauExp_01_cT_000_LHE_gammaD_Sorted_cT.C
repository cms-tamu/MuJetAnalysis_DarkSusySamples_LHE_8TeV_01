...
//=========  (Mon Mar 16 12:51:11 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-2.125,-1.851109,10.375,12.38819);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(11.39144);
   ...
   h_gammaD_1_cT->SetBinContent(1,6.307329);
   h_gammaD_1_cT->SetBinContent(2,2.322029);
   h_gammaD_1_cT->SetBinContent(3,0.8871361);
   h_gammaD_1_cT->SetBinContent(4,0.3013788);
   h_gammaD_1_cT->SetBinContent(5,0.1120014);
   h_gammaD_1_cT->SetBinContent(6,0.04500056);
   h_gammaD_1_cT->SetBinContent(7,0.0158752);
   h_gammaD_1_cT->SetBinContent(8,0.005625071);
   h_gammaD_1_cT->SetBinContent(9,0.002625033);
   h_gammaD_1_cT->SetBinContent(10,0.0007500094);
   ...
   h_gammaD_2_cT->SetBinContent(1,6.328579);
   h_gammaD_2_cT->SetBinContent(2,2.326779);
   h_gammaD_2_cT->SetBinContent(3,0.8471356);
   h_gammaD_2_cT->SetBinContent(4,0.3053788);
   h_gammaD_2_cT->SetBinContent(5,0.1190015);
   h_gammaD_2_cT->SetBinContent(6,0.04537557);
   h_gammaD_2_cT->SetBinContent(7,0.01775022);
   h_gammaD_2_cT->SetBinContent(8,0.006500081);
   h_gammaD_2_cT->SetBinContent(9,0.002125027);
   h_gammaD_2_cT->SetBinContent(10,0.0008750109);
   h_gammaD_2_cT->SetBinContent(11,0.0003750047);
