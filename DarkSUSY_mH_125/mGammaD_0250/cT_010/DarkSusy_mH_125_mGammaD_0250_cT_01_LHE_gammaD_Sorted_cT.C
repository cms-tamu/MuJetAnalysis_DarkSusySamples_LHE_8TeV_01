...
//=========  (Mon Mar 16 16:16:03 2015) by ROOT version5.34/18
   ...
   cnv->Range(-0.10625,-1.876859,0.51875,12.56052);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(11.5499);
   ...
   h_gammaD_1_cT->SetBinContent(1,6.307693);
   h_gammaD_1_cT->SetBinContent(2,2.247492);
   h_gammaD_1_cT->SetBinContent(3,0.9832776);
   h_gammaD_1_cT->SetBinContent(4,0.3478261);
   h_gammaD_1_cT->SetBinContent(5,0.1137124);
   h_gammaD_1_cT->SetBinContent(6,0.06020067);
   h_gammaD_1_cT->SetEntries(1504);
   ...
   h_gammaD_2_cT->SetBinContent(1,6.416611);
   h_gammaD_2_cT->SetBinContent(2,2.283992);
   h_gammaD_2_cT->SetBinContent(3,0.8372405);
   h_gammaD_2_cT->SetBinContent(4,0.3683858);
   h_gammaD_2_cT->SetBinContent(5,0.09377093);
   h_gammaD_2_cT->SetBinContent(6,0.07367716);
   h_gammaD_2_cT->SetEntries(1504);
