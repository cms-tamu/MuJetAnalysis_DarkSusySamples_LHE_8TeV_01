...
//=========  (Mon Mar 16 16:33:50 2015) by ROOT version5.34/18
   ...
   cnv->Range(-0.053125,-3.709284,0.259375,24.82367);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(22.82636);
   ...
   h_gammaD_1_cT->SetBinContent(1,12.79435);
   h_gammaD_1_cT->SetBinContent(2,4.648189);
   h_gammaD_1_cT->SetBinContent(3,1.690205);
   h_gammaD_1_cT->SetBinContent(4,0.6338897);
   h_gammaD_1_cT->SetBinContent(5,0.2333661);
   h_gammaD_1_cT->SetBinContent(6,0.1392141);
   ...
   h_gammaD_2_cT->SetBinContent(1,12.68131);
   h_gammaD_2_cT->SetBinContent(2,4.679652);
   h_gammaD_2_cT->SetBinContent(3,1.766571);
   h_gammaD_2_cT->SetBinContent(4,0.6401933);
   h_gammaD_2_cT->SetBinContent(5,0.2322714);
   h_gammaD_2_cT->SetBinContent(6,0.1316121);
