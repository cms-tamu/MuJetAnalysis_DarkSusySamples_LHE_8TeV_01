...
//=========  (Mon Mar 16 16:33:44 2015) by ROOT version5.34/18
   ...
   cnv->Range(-0.10625,-1.86115,0.51875,12.45539);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(11.45323);
   ...
   h_gammaD_1_cT->SetBinContent(1,6.374217);
   h_gammaD_1_cT->SetBinContent(2,2.345303);
   h_gammaD_1_cT->SetBinContent(3,0.8534437);
   h_gammaD_1_cT->SetBinContent(4,0.3102745);
   h_gammaD_1_cT->SetBinContent(5,0.1167619);
   ...
   h_gammaD_2_cT->SetBinContent(1,6.362905);
   h_gammaD_2_cT->SetBinContent(2,2.34485);
   h_gammaD_2_cT->SetBinContent(3,0.8588564);
   h_gammaD_2_cT->SetBinContent(4,0.3174663);
   h_gammaD_2_cT->SetBinContent(5,0.1159223);
   h_gammaD_2_cT->SetBinContent(6,0.05821263);
