...
//=========  (Mon Mar 16 14:03:56 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-2.125,-1.850378,10.375,12.3833);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(11.38694);
   ...
   h_gammaD_1_cT->SetBinContent(1,6.332704);
   h_gammaD_1_cT->SetBinContent(2,2.330029);
   h_gammaD_1_cT->SetBinContent(3,0.8478856);
   h_gammaD_1_cT->SetBinContent(4,0.3082539);
   h_gammaD_1_cT->SetBinContent(5,0.1160014);
   h_gammaD_1_cT->SetBinContent(6,0.04075051);
   h_gammaD_1_cT->SetBinContent(7,0.01537519);
   h_gammaD_1_cT->SetBinContent(8,0.005125064);
   h_gammaD_1_cT->SetBinContent(9,0.002750034);
   h_gammaD_1_cT->SetBinContent(10,0.0006250078);
   h_gammaD_1_cT->SetBinContent(11,0.0003750047);
   ...
   h_gammaD_2_cT->SetBinContent(1,6.326079);
   h_gammaD_2_cT->SetBinContent(2,2.331279);
   h_gammaD_2_cT->SetBinContent(3,0.8538857);
   h_gammaD_2_cT->SetBinContent(4,0.3156289);
   h_gammaD_2_cT->SetBinContent(5,0.1152514);
   h_gammaD_2_cT->SetBinContent(6,0.03712546);
   h_gammaD_2_cT->SetBinContent(7,0.01450018);
   h_gammaD_2_cT->SetBinContent(8,0.003000038);
   h_gammaD_2_cT->SetBinContent(9,0.001750022);
   h_gammaD_2_cT->SetBinContent(10,0.001125014);
   h_gammaD_2_cT->SetBinContent(11,0.0002500031);
   h_gammaD_2_cT->SetBinContent(12,0.0001250016);
