...
//=========  (Mon Mar 16 16:33:56 2015) by ROOT version5.34/18
   ...
   cnv->Range(-0.2125,-0.9339766,1.0375,6.250459);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(5.747549);
   ...
   h_gammaD_1_cT->SetBinContent(1,3.167793);
   h_gammaD_1_cT->SetBinContent(2,1.177843);
   h_gammaD_1_cT->SetBinContent(3,0.4341673);
   h_gammaD_1_cT->SetBinContent(4,0.1600689);
   h_gammaD_1_cT->SetBinContent(5,0.06012806);
   h_gammaD_1_cT->SetBinContent(6,0.03157352);
   ...
   h_gammaD_2_cT->SetBinContent(1,3.193083);
   h_gammaD_2_cT->SetBinContent(2,1.166161);
   h_gammaD_2_cT->SetBinContent(3,0.4233949);
   h_gammaD_2_cT->SetBinContent(4,0.1568852);
   h_gammaD_2_cT->SetBinContent(5,0.06047601);
   h_gammaD_2_cT->SetBinContent(6,0.03435994);
