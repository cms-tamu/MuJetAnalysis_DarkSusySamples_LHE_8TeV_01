...
//=========  (Mon Mar 16 16:33:52 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.53125,-0.372446,2.59375,2.492524);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(2.291976);
   ...
   h_gammaD_1_cT->SetBinContent(1,1.273784);
   h_gammaD_1_cT->SetBinContent(2,0.4634665);
   h_gammaD_1_cT->SetBinContent(3,0.1761057);
   h_gammaD_1_cT->SetBinContent(4,0.06321485);
   h_gammaD_1_cT->SetBinContent(5,0.02342875);
   ...
   h_gammaD_2_cT->SetBinContent(1,1.27332);
   h_gammaD_2_cT->SetBinContent(2,0.4689006);
   h_gammaD_2_cT->SetBinContent(3,0.1707541);
   h_gammaD_2_cT->SetBinContent(4,0.06372136);
   h_gammaD_2_cT->SetBinContent(5,0.0233041);
