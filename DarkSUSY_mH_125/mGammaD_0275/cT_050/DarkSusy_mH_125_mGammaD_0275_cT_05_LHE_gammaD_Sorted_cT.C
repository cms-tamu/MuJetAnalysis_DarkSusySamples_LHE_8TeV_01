...
//=========  (Mon Mar 16 16:32:42 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.53125,-0.3726601,2.59375,2.493956);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(2.293293);
   ...
   h_gammaD_1_cT->SetBinContent(1,1.271835);
   h_gammaD_1_cT->SetBinContent(2,0.4717342);
   h_gammaD_1_cT->SetBinContent(3,0.1694437);
   h_gammaD_1_cT->SetBinContent(4,0.06367984);
   h_gammaD_1_cT->SetBinContent(5,0.02330733);
   h_gammaD_1_cT->SetBinContent(6,0.01356657);
   ...
   h_gammaD_2_cT->SetBinContent(1,1.274052);
   h_gammaD_2_cT->SetBinContent(2,0.4666038);
   h_gammaD_2_cT->SetBinContent(3,0.1713783);
   h_gammaD_2_cT->SetBinContent(4,0.06446499);
   h_gammaD_2_cT->SetBinContent(5,0.02350129);
   h_gammaD_2_cT->SetBinContent(6,0.01293326);
