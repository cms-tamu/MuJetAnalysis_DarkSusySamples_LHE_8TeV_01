...
//=========  (Mon Mar 16 13:27:19 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-2.125,-1.846795,10.375,12.35932);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(11.36489);
   ...
   h_gammaD_1_cT->SetBinContent(1,6.334954);
   h_gammaD_1_cT->SetBinContent(2,2.318279);
   h_gammaD_1_cT->SetBinContent(3,0.8541357);
   h_gammaD_1_cT->SetBinContent(4,0.3105039);
   h_gammaD_1_cT->SetBinContent(5,0.1133764);
   h_gammaD_1_cT->SetBinContent(6,0.04125052);
   h_gammaD_1_cT->SetBinContent(7,0.01687521);
   h_gammaD_1_cT->SetBinContent(8,0.006250078);
   h_gammaD_1_cT->SetBinContent(9,0.003125039);
   h_gammaD_1_cT->SetBinContent(10,0.001125014);
   ...
   h_gammaD_2_cT->SetBinContent(1,6.313829);
   h_gammaD_2_cT->SetBinContent(2,2.329404);
   h_gammaD_2_cT->SetBinContent(3,0.8628858);
   h_gammaD_2_cT->SetBinContent(4,0.3106289);
   h_gammaD_2_cT->SetBinContent(5,0.1137514);
   h_gammaD_2_cT->SetBinContent(6,0.04337554);
   h_gammaD_2_cT->SetBinContent(7,0.01662521);
   h_gammaD_2_cT->SetBinContent(8,0.005500069);
   h_gammaD_2_cT->SetBinContent(9,0.002000025);
   h_gammaD_2_cT->SetBinContent(10,0.001500019);
