...
//=========  (Mon Mar 16 16:32:44 2015) by ROOT version5.34/18
   ...
   cnv->Range(-0.10625,-1.85972,0.51875,12.44582);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(11.44443);
   ...
   h_gammaD_1_cT->SetBinContent(1,6.378809);
   h_gammaD_1_cT->SetBinContent(2,2.334328);
   h_gammaD_1_cT->SetBinContent(3,0.8600486);
   h_gammaD_1_cT->SetBinContent(4,0.3126534);
   h_gammaD_1_cT->SetBinContent(5,0.1141613);
   h_gammaD_1_cT->SetBinContent(6,0.0692268);
   ...
   h_gammaD_2_cT->SetBinContent(1,6.358018);
   h_gammaD_2_cT->SetBinContent(2,2.345707);
   h_gammaD_2_cT->SetBinContent(3,0.8689249);
   h_gammaD_2_cT->SetBinContent(4,0.3128029);
   h_gammaD_2_cT->SetBinContent(5,0.1145475);
   h_gammaD_2_cT->SetBinContent(6,0.06998729);
