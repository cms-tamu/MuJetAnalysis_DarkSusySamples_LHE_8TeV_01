...
//=========  (Mon Mar 16 16:32:46 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.2125,-0.9297196,1.0375,6.22197);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(5.721352);
   ...
   h_gammaD_1_cT->SetBinContent(1,3.191896);
   h_gammaD_1_cT->SetBinContent(2,1.167799);
   h_gammaD_1_cT->SetBinContent(3,0.4267648);
   h_gammaD_1_cT->SetBinContent(4,0.1567887);
   h_gammaD_1_cT->SetBinContent(5,0.05675098);
   h_gammaD_1_cT->SetBinContent(6,0.033283);
   ...
   h_gammaD_2_cT->SetBinContent(1,3.178529);
   h_gammaD_2_cT->SetBinContent(2,1.168838);
   h_gammaD_2_cT->SetBinContent(3,0.4310616);
   h_gammaD_2_cT->SetBinContent(4,0.1630483);
   h_gammaD_2_cT->SetBinContent(5,0.05852369);
