...
//=========  (Mon Mar 16 16:32:42 2015) by ROOT version5.34/18
   ...
   cnv->Range(-0.053125,-3.72027,0.259375,24.89719);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(22.89397);
   ...
   h_gammaD_1_cT->SetBinContent(1,12.75932);
   h_gammaD_1_cT->SetBinContent(2,4.661883);
   h_gammaD_1_cT->SetBinContent(3,1.729859);
   h_gammaD_1_cT->SetBinContent(4,0.6102719);
   h_gammaD_1_cT->SetBinContent(5,0.2386707);
   h_gammaD_1_cT->SetBinContent(6,0.1407351);
   ...
   h_gammaD_2_cT->SetBinContent(1,12.71887);
   h_gammaD_2_cT->SetBinContent(2,4.690313);
   h_gammaD_2_cT->SetBinContent(3,1.720243);
   h_gammaD_2_cT->SetBinContent(4,0.6376308);
   h_gammaD_2_cT->SetBinContent(5,0.2329417);
   h_gammaD_2_cT->SetBinContent(6,0.1460608);
